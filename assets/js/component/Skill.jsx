      ...
      <section className={style['container-fluid']}>
        ...
        <div className={style.row}>
          ...
          <div className={contentBox}>
            <div className={style['skill-box']}>
              <div className={style.icon_wrap}>
                <i className={arr}>query_builder</i>
              </div>
              <h3>Build</h3>
          ...
          <div className={contentBox}>
            <div className={style['skill-box']}>
              <div className={style.icon_wrap}>
                <i className={arr}>photo_library</i>
              </div>
              <h3>GRAPHIC-TOOL</h3>
          ...
          <div className={contentBox}>
            <div className={style['skill-box']}>
              <div className={style.icon_wrap}>
                <i className={arr}>import_export</i>
              </div>
          ...
          <div className={contentBox}>
            <div className={style['skill-box']}>
              <div className={style.icon_wrap}>
                <i className={arr}>verified_user</i>
              </div>
              <h3>SERVER & OTHER</h3>
